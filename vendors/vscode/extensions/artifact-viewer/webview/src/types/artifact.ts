...
export function parseRelated(related: string[] | string | undefined): string[] {
  if (!related) return [];
...
export function isFocusItem(artifact: ArtifactRow): boolean {
  return artifact.next != null || artifact.status === "needs-me";
}
